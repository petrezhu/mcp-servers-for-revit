...
const CODE_MODE_TOOL_FILES = new Set([
  ...
  "lookup_engine_query.ts",
  "lookup_engine_query.js",
  "navigate_object.ts",
  "navigate_object.js",
  "object_member_groups.ts",
  "object_member_groups.js",
  "search.ts",
  "search.js",
  "selection_roots.ts",
  "selection_roots.js",
...
const CODE_MODE_TOOL_PRIORITY = new Map([
  ["execute.ts", 0],
  ["execute.js", 0],
  ["selection_roots.ts", 1],
  ["selection_roots.js", 1],
  ["object_member_groups.ts", 2],
  ["object_member_groups.js", 2],
  ["expand_members.ts", 3],
  ["expand_members.js", 3],
  ["navigate_object.ts", 4],
  ["navigate_object.js", 4],
  ["get_runtime_context.ts", 5],
  ["get_runtime_context.js", 5],
  ["lookup_engine_query.ts", 6],
  ["lookup_engine_query.js", 6],
  ["search.ts", 7],
  ["search.js", 7],
  ["exec.ts", 8],
  ["exec.js", 8],
